...
@Component
class ApiServicesImpl @Autowired constructor(private val restTemplate: RestTemplate) : RegisterNodeApiService, RelayApiService, PlayApiService {
    ...
    override fun relayMessage(message: String, signatures: Signatures): Signature {
        ...
        if (nextNode != null) {
            ...
            val newSignatures = signatures.items + newSignature
    ...
    internal fun registerToServer(registerHost: String, registerPort: Int) {
        ...
        try {
            ...
            println("Error en registerToServer: ${e.message}")
        }
    }
    ...
    private fun sendRelayMessage(body: String, contentType: String, relayNode: RegisterResponse, signatures: Signatures) {
        ...
        try {
            restTemplate.postForEntity(url, HttpEntity(requestBody, requestHeaders), Signature::class.java)
        } catch (e: Exception) {
            println("Error en relayMessage: ${e.message}")
        }
    }
